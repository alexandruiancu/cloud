...
echo "ANDU DEBUG @@ create_count: ${create_count}; create_success: ${create_success_count}; expected: ${expected_count}"
...
echo "ANDU DEBUG @@ read_count: ${read_test3_part2_success_count}; QUORUM: ${QUORUMPLUSONE}; RFP: ${RFPLUSONE}"
